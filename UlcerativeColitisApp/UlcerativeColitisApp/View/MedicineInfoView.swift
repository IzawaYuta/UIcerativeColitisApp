...
//    @State private var showDosingTimeList: Bool = false
//    @State private var alertNameEmpty: Bool = false
//    @State private var dosingTimeNotificationToggles: [Bool] = [] // 通知トグル
//    
//    private var allUnits: [String] {
//        Array(Set(medicineDataModel.flatMap { $0.unitList })).sorted()
//    }
...
//                                        showingDatePickerSheet = false
//                                        dosingTimeList.append(newDosingTime)
//                                        dosingTimeNotificationToggles.append(false) // 新しい時間にトグル追加
//                                    }
//                                }
//                            }
//                        }
...
//                    if let overwriteMedicine = medicineDataModel.first(where: { $0.id == self.overwriteMedicine?.id }) {
//                        let overwriteDosingTime = overwriteMedicine.dosingTime
//                        ForEach(Array(overwriteDosingTime.enumerated()), id: \ .element) { index, time in
//                            HStack {
//                                Text(time ?? Date(), formatter: dateFormatter)
//                                Toggle("通知", isOn: Binding(
//                                    get: { dosingTimeNotificationToggles.indices.contains(index) ? dosingTimeNotificationToggles[index] : false },
//                                    set: { newValue in
//                                        if dosingTimeNotificationToggles.indices.contains(index) {
//                                            dosingTimeNotificationToggles[index] = newValue
//                                            if let t = time {
//                                                if newValue {
//                                                    scheduleNotification(for: t)
//                                                } else {
//                                                    removeNotification(for: t)
//                                                }
//                                            }
//                                        }
//                                    }
...
//                        }
//                    } else {
//                        ForEach(Array(dosingTimeList.enumerated()), id: \ .element) { index, time in
//                            HStack {
//                                Text(time, formatter: dateFormatter)
//                                Toggle("通知", isOn: Binding(
//                                    get: { dosingTimeNotificationToggles.indices.contains(index) ? dosingTimeNotificationToggles[index] : false },
...
//                }
//                // 通知トグルの初期化
//                if let overwriteMedicine = overwriteMedicine {
//                    let count = overwriteMedicine.dosingTime.count
//                    if dosingTimeNotificationToggles.count != count {
//                        dosingTimeNotificationToggles = Array(repeating: false, count: count)
//                    }
//                } else {
//                    if dosingTimeNotificationToggles.count != dosingTimeList.count {
//                        dosingTimeNotificationToggles = Array(repeating: false, count: dosingTimeList.count)
//                    }
//                }
//            }
//            .padding()
...
//        content.body = "服用時間になりました"
//        content.sound = .default
//        let triggerDate = Calendar.current.dateComponents([.hour, .minute], from: date)
//        let trigger = UNCalendarNotificationTrigger(dateMatching: triggerDate, repeats: true)
//        let request = UNNotificationRequest(identifier: "medicine_\(date.timeIntervalSince1970)", content: content, trigger: trigger)
//        UNUserNotificationCenter.current().add(request)
//    }
//    private func removeNotification(for date: Date) {
//        let identifier = "medicine_\(date.timeIntervalSince1970)"
